...
function Allproducttxt1() {
  return (
    <div className="div-allproduct-txt">
      <div>
        <h2 className="h2-allproduct-txt">All Our Packaging Products</h2>
      ...
      <div>
        ...
        <p className="pend-allproduct-txt">With many options and services to choose from, contact our representatives now to position your order.</p>
      </div>
    </div>
  );
}

export default Allproducttxt1;
