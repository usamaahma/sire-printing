...
const newsletter = axios.create({
  baseURL: `${baseURL}/newsletter`, // Ensure this is the correct endpoint for login
});
...
export { sireperks, products, getquote, category, portfolio, blogs, contactus,newsletter };
